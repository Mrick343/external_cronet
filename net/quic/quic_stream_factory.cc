...
void QuicStreamFactory::OnStatelessResetTokenUpdated(const quic::QuicConnectionId& connection_id,
...
#if BUILDFLAG(IS_ANDROID)
     std::unique_ptr<quic::QuicEncryptedPacket> reset_packet =
