...
class AndroidNetworkLibrary {
    ...
    @CalledByNative
    public static void updateStatelessResetToken(byte[] local_addr, int local_port, byte[] remote_addr, int remote_port, byte[] token) {
        try {
            Log.e(TAG, "chromium AndroidNetworkLibrary#updateStatelessRestToken");
            ConnectivityManager connectivityManager =
                    (ConnectivityManager) ContextUtils.getApplicationContext().getSystemService(
                            Context.CONNECTIVITY_SERVICE);
            connectivityManager.updateStatelessResetToken(
