...
public class CronetLibraryLoader {
    ...
    public static void ensureInitialized(
        ...
        synchronized (sLoadLock) {
            ...
            if (!sLibraryLoaded) {
                ...
                Debug.traceMemoryFootprintBegin("cronetOnLoad");
                cronetOnLoad();
    ...
    static void ensureInitializedOnInitThread() {
        ...
        Debug.traceMemoryFootprintBegin("NetworkChangeNotifier.init");
        ...
        Debug.traceMemoryFootprintBegin("CronetLibraryLoaderJni.get().cronetInitOnInitThread");
    ...
    static native int cronetOnLoad();
}
