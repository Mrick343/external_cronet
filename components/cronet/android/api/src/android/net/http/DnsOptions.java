...
public final class DnsOptions {
    ...
    public static class StaleDnsOptions {
        ...
        public static final class Builder {
            ...
            public Builder setAllowCrossNetworkUsageEnabled(@DnsOptionEnabled int enabled) {
                if (enabled == DNS_OPTION_UNSPECIFIED) {
                    this.mAllowCrossNetworkUsage = null;
                } else {
                    this.mAllowCrossNetworkUsage = (enabled == DNS_OPTION_ENABLED);
                }
                return this;
            }
            ...
            public Builder setUseStaleOnNameNotResolvedEnabled(@DnsOptionEnabled int enabled) {
                if (enabled == DNS_OPTION_UNSPECIFIED) {
                    this.mUseStaleOnNameNotResolved = null;
                } else {
                    this.mUseStaleOnNameNotResolved = (enabled == DNS_OPTION_ENABLED);
                }
                return this;
            }
    ...
    public static final class Builder {
        ...
        public Builder setUseHttpStackDnsResolverEnabled(@DnsOptionEnabled int enabled) {
            if (enabled == DNS_OPTION_UNSPECIFIED) {
                this.mUseHttpStackDnsResolver = null;
            } else {
                this.mUseHttpStackDnsResolver = (enabled == DNS_OPTION_ENABLED);
            }
            return this;
        }
        ...
        public Builder setStaleDnsEnabled(@DnsOptionEnabled int enabled) {
            if (enabled == DNS_OPTION_UNSPECIFIED) {
                this.mEnableStaleDns = null;
            } else {
                this.mEnableStaleDns = (enabled == DNS_OPTION_ENABLED);
            }
            return this;
        }
        ...
        public Builder setPreestablishConnectionsToStaleDnsResultsEnabled(
            ...
            if (enabled == DNS_OPTION_UNSPECIFIED) {
                this.mPreestablishConnectionsToStaleDnsResults = null;
            } else {
                this.mPreestablishConnectionsToStaleDnsResults = (enabled == DNS_OPTION_ENABLED);
            }
            return this;
        }
        ...
        public Builder setPersistHostCacheEnabled(@DnsOptionEnabled int enabled) {
            if (enabled == DNS_OPTION_UNSPECIFIED) {
                this.mPersistHostCache = null;
            } else {
                this.mPersistHostCache = (enabled == DNS_OPTION_ENABLED);
            }
            return this;
        }
