...
public abstract class CronetEngine {
    ...
    public static class Builder {
        ...
        private static ICronetEngineBuilder createBuilderDelegate(Context context) {
            // TODO make the impl visible and just return the builder implementation directly
            try {
                ...
                try {
                    Class<?> clazz = CronetEngine.class.getClassLoader().loadClass(
                            "org.chromium.net.impl.NativeCronetEngineBuilderImpl");

                    return (ICronetEngineBuilder) clazz.getConstructor(Context.class).newInstance(
                            context);
                } catch (ClassNotFoundException | NoSuchMethodException | InstantiationException | IllegalAccessException | InvocationTargetException ee) {
