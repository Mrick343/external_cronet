...
public abstract class UrlRequest {
    ...
    public abstract static class Builder {
         ...
         * @return the builder to facilitate chaining.
         */
        // SuppressLint: UploadDataProvider is a class to contain methods to provide an upload body
        // and getter would not be useful
     ...
     * {@code UploadDataProvider}s and {@code UrlRequest.Callback}s) is intentionally performing
     * inline execution. See {@link UrlRequest.Builder#setAllowDirectExecutorEnabled(boolean)}
     *
