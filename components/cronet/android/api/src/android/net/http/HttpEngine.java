...
public abstract class HttpEngine {
    ...
    public static class Builder {
         ...
         */
        // SuppressLint: API to get default user agent that could include system build version, model
        // and Id, and Cronet version.
         ...
         */
        // SuppressLint: value is maintained by JNI code after build
         ...
         * @return the builder to facilitate chaining.
         */
        // TODO(motomuman) comment SuppressLint
        @NonNull @SuppressLint("MissingGetterMatchingBuilder")
