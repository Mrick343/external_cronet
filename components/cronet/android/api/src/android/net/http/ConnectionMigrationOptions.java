...
public class ConnectionMigrationOptions {
    ...
    public static final class Builder {
         ...
         */
        @NonNull
        public Builder setDefaultNetworkMigrationState(@MigrationOptionState int state) {
         ...
         */
        @NonNull
        public Builder setPathDegradationMigrationState(@MigrationOptionState int state) {
        ...
        @Experimental
        @NonNull
        public Builder setAllowNonDefaultNetworkUsageState(@MigrationOptionState int state) {
