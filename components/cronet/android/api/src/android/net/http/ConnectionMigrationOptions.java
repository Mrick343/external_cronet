...
public class ConnectionMigrationOptions {
     ...
     * Option is enabled.
     */
    public static final int MIGRATION_OPTION_ENABLED = 0;

    /**
     * Option is disabled.
     */
    public static final int MIGRATION_OPTION_DISABLED = 1;

    /**
     * Option is unspecified.
     */
    public static final int MIGRATION_OPTION_UNSPECIFIED = 2;
    ...
    private static @MigrationOptionEnabled int getMigrationOptionEnabled(Boolean enabled) {
        if (enabled == null) {
            return MIGRATION_OPTION_UNSPECIFIED;
        } else if (enabled) {
            return MIGRATION_OPTION_ENABLED;
        } else {
            return MIGRATION_OPTION_DISABLED;
        }
    }
    ...
    public @MigrationOptionEnabled int getDefaultNetworkMigrationEnabled() {
        return getMigrationOptionEnabled(mEnableDefaultNetworkMigration);
    }
    ...
    public @MigrationOptionEnabled int getPathDegradationMigrationEnabled() {
        return getMigrationOptionEnabled(mEnablePathDegradationMigration);
    }
    ...
    public @MigrationOptionEnabled int getAllowNonDefaultNetworkUsageEnabled() {
        return getMigrationOptionEnabled(mAllowNonDefaultNetworkUsage);
    }
    ...
    public static final class Builder {
         ...
         */
        @NonNull
        public Builder setDefaultNetworkMigrationEnabled(@MigrationOptionEnabled int enable) {
            if (enable == MIGRATION_OPTION_UNSPECIFIED) {
                this.mEnableDefaultNetworkMigration = null;
            } else {
                this.mEnableDefaultNetworkMigration = (enable == MIGRATION_OPTION_ENABLED);
            }
            return this;
        }
         ...
         */
        @NonNull
        public Builder setPathDegradationMigrationEnabled(@MigrationOptionEnabled int enable) {
            if (enable == MIGRATION_OPTION_UNSPECIFIED) {
                this.mEnablePathDegradationMigration = null;
            } else {
                this.mEnablePathDegradationMigration = (enable == MIGRATION_OPTION_ENABLED);
            }
            return this;
        }
         ...
         * {@link #setPathDegradationMigrationEnabled} to true to have any effect.
         *
        ...
        @Experimental
        @NonNull
        public Builder setAllowNonDefaultNetworkUsageEnabled(@MigrationOptionEnabled int enable) {
            if (enable == MIGRATION_OPTION_UNSPECIFIED) {
                this.mAllowNonDefaultNetworkUsage = null;
            } else {
                this.mAllowNonDefaultNetworkUsage = (enable == MIGRATION_OPTION_ENABLED);
            }
            return this;
        }
         ...
         *
         * <p>Only relevant if {@link #setAllowNonDefaultNetworkUsageEnabled(int)} is enabled.
         *
         * @return this builder for chaining
         *
         * {@hide}
