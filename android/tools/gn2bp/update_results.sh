...
BASEDIR=$(dirname "$0")
$BASEDIR/gen_android_bp --desc $BASEDIR/data/desc_x64.json --desc $BASEDIR/data/desc_x86.json \
--desc $BASEDIR/data/desc_arm.json --desc $BASEDIR/data/desc_arm64.json --out $BASEDIR/Android.bp
